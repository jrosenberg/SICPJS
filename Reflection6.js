...
//Julie's answer
function sads(t1, t2, t3) {
    return w => t => (w(t) * (t < t1 || t > t3 //silent
                              ? 0
                              : t < t2 // ramp up
                              ? (t-t1)/(t2-t1)
                              : 1 - (t-t2)/(t3-t2))) // ramp down
                      );
}
//transformation -- takes args, gives xform function
//wave is map from t to something
//max should be 1 at t2 
